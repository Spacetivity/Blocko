...
class EndingCountdown(arenaId: ArenaId) : GameCountdown(arenaId, Blocko.instance.globalConfigFile.endingCountdownSeconds) {

    override fun handleCountdownIdle(countdownTask: BukkitTask, remainingSeconds: Int) {
        val arena = Blocko.instance.arenaHandler.getArena(this.arenaId) ?: return
