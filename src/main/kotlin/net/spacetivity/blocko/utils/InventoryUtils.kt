...
object InventoryUtils {
    ...
    fun openGameTeamSetupInventory(opener: Player, invType: InvType, block: Block) {
        ...
        val title: Component = BlockoGame.instance.translationHandler.getSelectedTranslation().validateLine("blocko.inventory.game_team_setup.title.entrance")
    ...
    fun openStatsInventory(opener: Player, statsPlayer: StatsPlayer) {
        ...
        val botIndicatorString = translation.validateLineAsString("blocko.bot.indicator")
        ...
        val title: Component = translation.validateLine(titleKey, Placeholder.parsed("player_name", gamePlayer.name), suffixPlaceholder)
